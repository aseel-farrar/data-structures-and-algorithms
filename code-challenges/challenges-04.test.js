...
const addTwo = (arr) => {
  // Solution code here...
  let nweArr = [];
  arr.forEach(item => nweArr.push(item + 2));
  return nweArr;
}
...
This function should use a regular expression pattern to return true if the input contains the word 'world' all in lower-case letters, and false if the input does not.
